...
def draw():
    ...
    big.noStroke()
    big.fill(color(210, 36, 72, 100))
    big.ellipse(big.width/2-offset, big.height/2-offset, r+offset, r+offset)
    big.fill(color(8.5, 82, 50, 100))
    big.ellipse(big.width/2+offset, big.height/2+offset, r+offset, r+offset)
    big.fill(color(0, 0, 0, 100))
    big.ellipse(big.width/2, big.height/2, r, r)
    big.endDraw()
    big.filter(BLUR, 50)
    ...
    lil.beginDraw()
    lil.noStroke()
    lil.fill(color(210, 36, 72, 100))
    lil.ellipse(big.width/2+offset, big.height/2+offset, r+offset, r+offset)
    lil.fill(color(8.5, 82, 50, 100))
    lil.ellipse(big.width/2-offset, big.height/2-offset, r+offset, r+offset)
    lil.fill(color(0, 0, 0, 100))
    lil.ellipse(big.width/2, big.height/2, r, r)
    lil.endDraw()
    lil.filter(BLUR, 40)
    image(lil, width/2, height/2)
    ...
    # pg.ellipse(pg.width/2, pg.height/2, 400, 400)
    # pg.endDraw()
    # imageMode(CENTER)
